...
function [c21s, c22s, results1, results2] = collection2_scores (filename, disp_on)
    ...
    for k=1:1%size(c22,2)
        ...
        temp = temp - min(temp(:));
        temp = temp / max(temp(:));
        G{1}= temp([18 24 17 20]);temp([18 24 17 20]);
        G{2}= temp([25 21 22 19]);temp([25 21 22 19]);
        G{3}= temp([5 3 2]);temp([5 3 2]);
        G{4}= temp([23 16 15]);temp([23 16 15]);
        G{5}= temp([6 4 14 12 13]);temp([6 4 14 12 13]);
        G{6}= temp([7 9 10 1 11 8]);temp([7 9 10 1 11 8]);
