// minor mods - PLR August 2018

/*
 *  Implementation of "An Efficiently Computable Metric for Comparing
 *  Polygonal Shapes," by
 *  E.M. Arkin, L.P. Chew, D.P. Huttenlocher, K.Kedem, and J.S.B. Mitchell,
 *  IEEE Transactions on Pattern Analysis and Machine Intelligence,
 *  vol. 13, no.  3, 1991, 209-216.
 *  This expands a little on the cited reference to achieve O(n) space and
 *  O(mn log n) run time.
 *
